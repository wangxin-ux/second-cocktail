...
const translations = {
  ...
  zh: {
    ...
    shapesDrink: "塑造你的酒", shapesDrinkFields: "今晚状态最重要，MBTI 只做轻调，星座塑造 Reveal 氛围。", connectionLater: "留给稍后的 Connection", connectionLaterFields: "昵称、年龄和公开见面地点，仅在你主动选择认识某人时使用。",
    ...
    nicknameUse: "用于今晚称呼你 · 仅在你开始 Connection 后展示", ageUse: "用于 Connection 参与资格 · 只展示年龄", meetingLocation: "见面地点", meetingLocationPlaceholder: "例如：二楼吧台", meetingLocationUse: "请选择公开、容易找到的位置。双方同意后，会从两人的地点中随机选出一个。", zodiacUse: "可选，用于 Reveal 与匹配解释 · 不直接展示", mbtiUse: "可选，用于轻调 Cocktail 与匹配解释 · 不直接展示", energyUse: "塑造 Cocktail 与匹配解释 · 可能出现在 Connection 预览中",
