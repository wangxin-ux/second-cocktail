...
const translations = {
  en: {
    ...
    profileBody: "Up to six signals shape your drink and tonight's match. This device remembers them for 30 minutes.",
    ...
    meetingLocation: "Where to find you", meetingLocationPlaceholder: "e.g. Bar counter, table 12", meetingLocationHelp: "Shown only after a match is accepted.",
    ...
    bartender: "For the bartender", scrollRecipe: "Scroll down · give your personal drink card to the bartender", matchEyebrow: "Tonight at second", matchTitle: "Would you meet someone through this drink?", matchBody: "This is the drink you created. Let it lead you to the person in this bar you may be meant to meet tonight.", findMatch: "Find My Tonight Match", makeAnother: "Make Another", startOver: "Start Over", mixingShort: "Mixing…",
    room: "Reading the room", drink: "Your drink", matchLabel: "second / match", matchIntroEyebrow: "Tonight in this bar", matchIntroTitle: "Who should you meet tonight?", matchIntroBody: "We'll combine your profile with the mood of {cocktail}.",
    matchSignals: "Match signals", fieldsAndDrink: "{count} profile fields + {spirit} × {flavor}", consent: "Use these signals for tonight's match.", readRoom: "Start matching", demoPool: "Live matching", meet: "Tonight, you should meet", whyTonight: "Why tonight", openingLine: "Your opening line", backMatch: "Back to Match Intro", fictional: "Live match", shared: "You share {reasons}.", different: "Your two drinks bring different energies to the same room.",
  ...
  zh: {
    ...
    profileBody: "最多六项信息会影响你的酒与今晚的匹配；这台设备会为你保留 30 分钟。",
    nickname: "昵称", nicknamePlaceholder: "我们该怎么称呼你？", age: "年龄", height: "身高", zodiac: "星座", energy: "今晚状态",
    meetingLocation: "见面位置", meetingLocationPlaceholder: "例如：吧台、12 号桌", meetingLocationHelp: "仅在匹配被同意后展示。",
    ...
    bartender: "给调酒师", scrollRecipe: "往下滑 · 把你的专属酒单给调酒师", matchEyebrow: "今晚，在 second", matchTitle: "你愿意通过这杯酒认识一个人吗？", matchBody: "下面是你生成的酒。让它带你遇见今晚这间酒吧里，也许最应该认识的人。", findMatch: "寻找今晚的 Match", makeAnother: "再调一杯", startOver: "重新开始", mixingShort: "调制中…",
    room: "正在读懂现场", drink: "你的酒", matchLabel: "second / 匹配", matchIntroEyebrow: "今晚，在这间酒吧", matchIntroTitle: "今晚，你该认识谁？", matchIntroBody: "我们会结合你的档案与「{cocktail}」的情绪。",
    matchSignals: "匹配信号", fieldsAndDrink: "{count} 项档案信息 + {spirit} × {flavor}", consent: "使用这些信息进行今晚的匹配。", readRoom: "开始匹配", demoPool: "实时匹配", meet: "今晚，你应该认识", whyTonight: "为什么是今晚", openingLine: "你的破冰开场", backMatch: "返回匹配介绍", fictional: "实时匹配", shared: "你们拥有 {reasons}。", different: "两杯酒为同一个空间带来了不同能量。",
