...
const translations = {
  en: {
    ...
    profileBody: "Your signals help Second understand tonight. They stay in this browser session.",
    shapesDrink: "Shapes your drink", shapesDrinkFields: "Energy leads. MBTI refines gently. Zodiac shapes the reveal.", connectionLater: "For connection later", connectionLaterFields: "Nickname, age, and a public meeting spot are used only if you choose to meet someone.",
    nickname: "Nickname", nicknamePlaceholder: "What should we call you?", age: "Age", zodiac: "Zodiac", energy: "Tonight's energy",
    ageError: "Enter an age from 18 to 99", profileSaved: "{count} of 6 added · all editable", profileSkip: "Skip all fields and continue if you prefer",
    nicknameUse: "Addresses you tonight · shown only if you start Connection", ageUse: "Connection eligibility · shown only as age", meetingLocation: "Meeting location", meetingLocationPlaceholder: "e.g. Bar counter, table 12", meetingLocationUse: "Choose an open, easy-to-find place. After mutual acceptance, one of your two locations is selected at random.", zodiacUse: "Optional reveal and match explanation · not shown directly", mbtiUse: "Optional cocktail refinement and match explanation · not shown directly", energyUse: "Shapes your cocktail and match explanation · may appear in your Connection preview",
  ...
  zh: {
    ...
    profileBody: "这些信号帮助 second 理解今晚的你；它们仅保留在当前浏览器会话。",
    shapesDrink: "塑造你的酒", shapesDrinkFields: "今晚状态最重要，性格类型只做轻调，星座塑造揭晓氛围。", connectionLater: "留给稍后的相遇", connectionLaterFields: "昵称、年龄和公开见面地点，仅在你主动选择认识某人时使用。",
    nickname: "昵称", nicknamePlaceholder: "我们该怎么称呼你？", age: "年龄", zodiac: "星座", energy: "今晚状态",
    ageError: "请输入 18 至 99 岁", profileSaved: "已填写 6 项中的 {count} 项 · 均可修改", profileSkip: "如愿意，可跳过全部信息继续",
    nicknameUse: "用于今晚称呼你 · 仅在你开始相遇后展示", ageUse: "用于相遇资格 · 只展示年龄", meetingLocation: "见面地点", meetingLocationPlaceholder: "例如：二楼吧台", meetingLocationUse: "请选择公开、容易找到的位置。双方同意后，会从两人的地点中随机选出一个。", zodiacUse: "可选，用于揭晓与匹配解释 · 不直接展示", mbtiUse: "可选，用于轻调鸡尾酒与匹配解释 · 不直接展示", energyUse: "塑造鸡尾酒与匹配解释 · 可能出现在相遇预览中",
    ...
    mixing: "正在准备固定配方", signature: "second 专属酒", aiSignature: "second 智能专属酒", classic: "经典配方", fixedRecipe: "固定菜单配方", madeFor: "为 {name} 而调。",
