...
const translations = {
  en: {
    ...
    flavorStep: "Step 03", craving: "What are you craving?", flavorBody: "Choose the mood of your drink.", base: "Base", generate: "Generate Cocktail", preparing: "Preparing…",
    mixing: "Mixing something unexpected", signature: "Second Signature", aiSignature: "Second AI Signature", classic: "Classic", madeFor: "Made for {name}.",
  ...
  zh: {
    ...
    flavorStep: "第 03 步", craving: "你现在想喝什么？", flavorBody: "选择这杯酒的情绪。", base: "基酒", generate: "生成鸡尾酒", preparing: "正在准备…",
    mixing: "正在调制一点意外", signature: "second 专属酒", aiSignature: "second AI 专属酒", classic: "经典配方", madeFor: "为 {name} 而调。",
