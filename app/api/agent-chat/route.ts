...
Allowed destination: home|profile|spirits|match. Use match only when the user explicitly asks to start or enter matching. Use profile when they ask to open/edit their information. Use spirits only when they explicitly ask to browse the drink list or choose manually.
